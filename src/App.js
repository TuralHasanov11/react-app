  ...
  return (
    <Layout>
      <Routes>
          ...
          <Route path='/auth' exact element={ !authCtx.isAuthenticated ? <AuthView /> : <Navigate to='/' />}></Route>
          <Route path='/profile' exact element={ authCtx.isAuthenticated ? <ProfileView />: <Navigate to='/auth?next=profile' />}></Route>
